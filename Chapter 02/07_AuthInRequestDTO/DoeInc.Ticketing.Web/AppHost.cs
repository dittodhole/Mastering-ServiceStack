...
namespace DoeInc.Ticketing.Web
{
    public class AppHost : AppHostBase
    {
        ...
        private void RegisterDependencies(Container container)
        {
            ...
            container.Register<IAuthRepository>(arg => new OrmLiteAuthRepository<CustomUserAuth, CustomUserAuthDetails>(arg.Resolve<IDbConnectionFactory>()))
                     .InitializedBy((arg,
                                     authRepository) =>
                                    {
                                        ...
                                        {
                                            var customUserAuth = new CustomUserAuth
                                                                 {
                                                                     UserName = "johndoe",
                                                                     FirstName = "John",
                                                                     LastName = "Doe",
                                                                     ImageUrl = "https://avatars1.githubusercontent.com/u/605728"
                                                                 };
                                            userAuthRepository.CreateUserAuth(customUserAuth,
                                                                              "password");
                                        }
                                    })
                     .ReusedWithin(ReuseScope.Container);
